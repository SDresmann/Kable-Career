...
const KableAcademyFinalSteps = () => {
  return (
    <div className='know-yourself container'>
    <h1>Lesson - 11 Kable Academy Final Steps</h1>
    ...
    <div className='row my-2 bg-info py-2'>
        ...
        <div className='col d-inline-flex flex-column'>
            <a href='https://www.indeed.com/career-advice/finding-a-job/how-to-get-an-entry-level-job'><button className='btn btn-outline-light mb-1 mx-5'>Article 1</button></a>
        </div>
        <div className='col d-inline-flex flex-column'>
...
export default KableAcademyFinalSteps
