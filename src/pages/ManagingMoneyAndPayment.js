...
const ManagingMoneyAndPayment = () => {
    return (
        <div className='know-yourself container'>
            <h1>Lesson - 12 Managing Money and Payments</h1>
            ...
            <div className='row my-2 bg-info py-2'>
                ...
                <div className='col d-inline-flex flex-column'>
                <a href='https://www.indeed.com/career-advice/career-development/why-financial-literacy-is-important'><button className='btn btn-outline-light mb-1 mx-5'>Article 1</button></a>
                </div>
                <div className='col d-inline-flex flex-column'>
...
export default ManagingMoneyAndPayment
